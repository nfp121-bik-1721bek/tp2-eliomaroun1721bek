...
public class FahrenheitCelsiusTest extends junit.framework.TestCase {
    ...
    public void test3() {
        assertEquals("    150 �F -> 65.6 �C ? ", 65.6, question2.FahrenheitCelsius.fahrenheitEnCelsius(150), 0.1);
    ...
    public void test2() {
        assertEquals("    10 �F -> -20 �C ? ", -20, question2.FahrenheitCelsius.fahrenheitEnCelsius(14), 0.1);
        assertEquals("  600 �F -> 67.8 �C ? ", 67.8, question2.FahrenheitCelsius.fahrenheitEnCelsius(600), 0.1);
